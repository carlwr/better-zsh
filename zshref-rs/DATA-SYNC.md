---
audience: maintainer
read-when: cross-repo TS→Rust data-sync design; dual-mode build; vendoring
---
...
The Rust build never runs TS code. Generation happens on the producer side; the producer hands Rust ready blobs. They arrive as *source-of-the-Rust-crate* at pre-publish time via the vendor target and ride inside the published `.crate` thereafter. End-user machines only ever see local files.
