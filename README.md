...
| [`zshref`](./zshref-rs) | Single-binary Rust CLI over the same tool surface. Pipes JSON on stdout. Offline; no Node, Python, or zsh runtime dependency. | `zshref-rs/` | crates.io, Homebrew (planned) |
