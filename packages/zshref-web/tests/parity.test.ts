...
// it pins the ranker's arithmetic against its own past. It was first
// generated by the Rust ranker, which the TS one mirrored bit-for-bit — every
// op at f32 precision (`Math.fround` + `Float32Array`).
