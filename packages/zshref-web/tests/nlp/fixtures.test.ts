...
describe('sanity fixture', () => {
  ...
  // The committed file was first generated by Rust from fastembed
  // embeddings; the S3 gate evidence that the TS pipeline reproduces it —
  // identities exact, scores within the embedder's drift. Holds trivially
  // once the file is TS-generated.
  it('sanity_fixture_reproduces_rust_within_eps', async (ctx) => {
